...
<script>
    // Date range filter
        minDateFilter = "";
        maxDateFilter = "";
        var link = '/dashboard/administrator/permission';
    ...
    $(document).ready(function() {
        aTable = $('#dataTables').DataTable({
            ...
            // pageLeght
            ajax: {
                url:'/dashboard/administrator/permission/get-permission',
            },
            columnDefs: [
                    ...
                    <form id="formData" method="POST">
                        ...
                        <input type="hidden" name="mainId" id="mainId">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="roleName" placeholder="" name="permissionName">
                            </div>
                            {{-- <div class="form-group">
                                <div class="flex">
                                    <label for="crud">CRUD</label><br>
                                    <div class="custom-control custom-checkbox-toggle custom-control-inline mr-1">
                                        <input type="checkbox" id="crud" value="true" name="crud" class="custom-control-input">
                                        <label class="custom-control-label" for="crud">Yes</label>
                                    </div>
                                    <label for="crud" class="mb-0">Yes</label>
                                </div>
                            </div> --}}
                    </form>
                </div> <!-- // END .modal-body -->
    ...
    @php
        $breadcrumb = [
            ...
            'pages' => [
                ...
                'Permission' => '/dashboard/administrator/permission'
            ],
            'nested' => true,
